...
```
aws ecr get-login-password --region eu-central-1 --profile [PROFILE] | docker login --username AWS --password-stdin 619071324692.dkr.ecr.eu-central-1.amazonaws.com
```
...
```
docker tag backend-loadtest:latest 619071324692.dkr.ecr.eu-central-1.amazonaws.com/backend-loadtest:latest
```

```
docker push 619071324692.dkr.ecr.eu-central-1.amazonaws.com/backend-loadtest:latest
```
